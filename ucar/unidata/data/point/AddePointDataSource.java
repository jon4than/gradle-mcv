...
public class AddePointDataSource extends PointDataSource {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AddePointDataSource.class);
    ...
    protected FieldImpl makeObs(DataChoice dataChoice, DataSelection subset,
            ...
            throws Exception {
        logger.trace("choice='{}' subset='{}' bbox='{}' sampleIt={}", dataChoice, subset, bbox, sampleIt);
        List realUrls;
        ...
        if (obs == null) {
            for (int i = 0; i < realUrls.size(); i++) {
                ...
                try {
                    ...
                    logger.trace("attempting to create PointDataAdapter using sourceUrl='{}'", sourceUrl);
