 ...
 * @version $Revision: 1.1 $ $Date: 2012/11/16 18:26:53 $
 */
public class AreaImageFlatField extends CachedFlatField implements SingleBandedImage {
    ...
    /** return new AreaImageFlatField with value 'op this' */
    @Override public Data binary(Data data, int op, MathType new_type, 
                      int sampling_mode, int error_mode)
                  throws VisADException, RemoteException
    {
//        System.out.println("AreaImageFlatField caught a binary with 5 args");
        FlatField newFF = (FlatField)super.binary(data, op, new_type, sampling_mode, error_mode);
        // TODO: this needs more testing if subtracting different data types
        AreaImageFlatField newAIFF = new AreaImageFlatField(
            aid,
            (FunctionType) newFF.getType(),
            newFF.getDomainSet(),
            newFF.getRangeCoordinateSystem()[0],
            newFF.getRangeSets(),
            newFF.getRangeUnits()[0],
            newFF.unpackFloats(), readLabel);
        return newAIFF;
    }
